          ...
          <div class="flex h-10 w-full" :class="title_bg_color_arr[index % 5]">
            <div class="flex justify-center items-center w-full">
              <input :id="'title_' + index" type="text"
                class="bg-transparent focus:bg-white border-none rounded-lg h-6 w-11/12 p-0" :value="snippetList[0].title"
          ...
          <view v-for="(snippet, sIndex) in snippetList" :key="sIndex">
            ...
            <div class="p-2">
              ...
              <div class="flex justify-end items-end mx-1 ">
                <ElButton :icon="Delete" size="small" circle plain @click="clearData(snippet.url, snippet.timestamp)" />
              </div>
            </div>
            <!-- 分割线 -->
